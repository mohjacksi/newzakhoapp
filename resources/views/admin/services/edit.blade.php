    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.services.update", [$service->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title_english') ? 'is-invalid' : '' }}" type="text" name="title_english" id="title_english" value="{{ old('title_english', $service->title_english) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title_arabic') ? 'is-invalid' : '' }}" type="text" name="title_arabic" id="title_arabic" value="{{ old('title_arabic', $service->title_arabic) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title_kurdish') ? 'is-invalid' : '' }}" type="text" name="title_kurdish" id="title_kurdish" value="{{ old('title_kurdish', $service->title_kurdish) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description_english') ? 'is-invalid' : '' }}" name="description_english" id="description_english">{!! old('description_english', $service->description_english) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description_arabic') ? 'is-invalid' : '' }}" name="description_arabic" id="description_arabic">{!! old('description_arabic', $service->description_arabic) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description_kurdish') ? 'is-invalid' : '' }}" name="description_kurdish" id="description_kurdish">{!! old('description_kurdish', $service->description_kurdish) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="text" name="phone" id="phone" value="{{ old('phone', $service->phone) }}">
                @if($errors->has('phone'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('whatsapp') ? 'is-invalid' : '' }}" type="text" name="whatsapp" id="whatsapp" value="{{ old('whatsapp', $service->whatsapp) }}">
