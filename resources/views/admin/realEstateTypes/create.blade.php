...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.realEstateType.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.real-estate-types.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="name_english">{{ trans('cruds.realEstateType.fields.name_english') }}</label>
                <input class="form-control {{ $errors->has('name_english') ? 'is-invalid' : '' }}" type="text" name="name_english" id="name_english" value="{{ old('name_english', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_arabic') ? 'is-invalid' : '' }}" type="text" name="name_arabic" id="name_arabic" value="{{ old('name_arabic', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_kurdish') ? 'is-invalid' : '' }}" type="text" name="name_kurdish" id="name_kurdish" value="{{ old('name_kurdish', '') }}">
