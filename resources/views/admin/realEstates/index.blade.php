...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-RealEstate">
            <thead>
                <tr>
                    <th width="10">
                ...
                <tr>
                    ...
                    <td>
                        <select class="search">
                            ...
                            @foreach($real_estate_types as $key => $item)
                                <option value="{{ $item->name_english }}">{{ $item->name_english }}</option>
                            @endforeach
                        </select>
                    </td>
                    <td>
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.real-estates.index') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
{ data: 'id', name: 'id' },
{ data: 'title_english', name: 'title_english' },
{ data: 'title_arabic', name: 'title_arabic' },
{ data: 'title_kurdish', name: 'title_kurdish' },
{ data: 'price', name: 'price' },
{ data: 'type_name_english', name: 'type.name_english' },
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-RealEstate').DataTable(dtOverrideGlobals);
