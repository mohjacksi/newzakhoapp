    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.real-estates.update", [$realEstate->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title_english') ? 'is-invalid' : '' }}" type="text" name="title_english" id="title_english" value="{{ old('title_english', $realEstate->title_english) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title_arabic') ? 'is-invalid' : '' }}" type="text" name="title_arabic" id="title_arabic" value="{{ old('title_arabic', $realEstate->title_arabic) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title_kurdish') ? 'is-invalid' : '' }}" type="text" name="title_kurdish" id="title_kurdish" value="{{ old('title_kurdish', $realEstate->title_kurdish) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description_english') ? 'is-invalid' : '' }}" name="description_english" id="description_english">{!! old('description_english', $realEstate->description_english) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description_arabic') ? 'is-invalid' : '' }}" name="description_arabic" id="description_arabic">{!! old('description_arabic', $realEstate->description_arabic) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description_kurdish') ? 'is-invalid' : '' }}" name="description_kurdish" id="description_kurdish">{!! old('description_kurdish', $realEstate->description_kurdish) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price') ? 'is-invalid' : '' }}" type="number" name="price" id="price" value="{{ old('price', $realEstate->price) }}" step="0.01">
                @if($errors->has('price'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('type') ? 'is-invalid' : '' }}" name="type_id" id="type_id">
                    @foreach($types as $id => $type)
                        <option value="{{ $id }}" {{ (old('type_id') ? old('type_id') : $realEstate->type->id ?? '') == $id ? 'selected' : '' }}>{{ $type }}</option>
                    @endforeach
                </select>
                @if($errors->has('type'))
