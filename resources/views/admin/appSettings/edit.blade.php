    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.app-settings.update", [$appSetting->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('key') ? 'is-invalid' : '' }}" type="text" name="key" id="key" value="{{ old('key', $appSetting->key) }}" required>
                @if($errors->has('key'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('value_english') ? 'is-invalid' : '' }}" type="text" name="value_english" id="value_english" value="{{ old('value_english', $appSetting->value_english) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('value_arabic') ? 'is-invalid' : '' }}" type="text" name="value_arabic" id="value_arabic" value="{{ old('value_arabic', $appSetting->value_arabic) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('value_kurdish') ? 'is-invalid' : '' }}" type="text" name="value_kurdish" id="value_kurdish" value="{{ old('value_kurdish', $appSetting->value_kurdish) }}">
